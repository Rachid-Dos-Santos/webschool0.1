...
<head>
    ...
    <title>Atividades Extra Curriculares</title>
</head>
<body>
    <!-- -------------------MENU DESKTOP------------------- -->
      ...
      <div>
        ...
        <li style="margin-right:3%;" class="logo01-desktop"><img width="35px" src="logos/Oxford-University-Circlet.svg.png" width="200px" alt="logo"></li>
         ...
         <a class="links-desktop  matricula" href="#">Matrícula</a>
          ...
          <li class="listas-desktop"><a style="color: white;" class="links-desktop" href="aec.php">AEC</a></li>
    ...
    <div class="not"><a style="border-radius:5px; padding:10px; position:absolute; margin-left:80%; text-decoration:none; color:white;" href="notificacoes.php" target="_top"><img width="30px" src="icons/comentario-alt.png" alt="notificacao"></a></div>
      ...
      <div class="menu-mobile">
        <ul class="submenu-mobile">
          ...
          <li class="listas-mobile"><a style="color: white;" class="links-mobile" href="aec.php">AEC</a></li>
  ...
  <div id="carouselExampleCaptions" class="carousel slide">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="imagens\side-view-smiley-girl-pool.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-md-block">
          <h5 style="color:white; text-shadow: black 1px 1px 1px;">Atividades Extra Curriculares</h5>
          <p style="color:white; text-shadow: black 1px 1px 1px;">Melhore a saúde corporal e mental com as atividades extra curriculares!</p>
          <input class="btn1" type="button" value="Saber Mais">
        </div>
      </div>
    </div>
  </div>
