  ...
  <!-- -------------------CORPO------------------- -->
      ...
      <section class="corpohome">
        <div><img width="100%"
         ...
         alt="mulher-afro-americana-de-aparencia-agradavel-segura-blocos-de-notas-papeis-estudos-na-faculdade-feliz-por-terminar-os-estudos"></div>

         <div class="slog">
            <p><img src="../logos\Oxford-University-Circlet.svg.png" alt="logo"></p>
            <h2>Venha construir o futuro!</h2>
            <p><a onclick="alerta()" href="../login.php"><input class="btn" type="button" value="Saber Mais"></a></p> 
         </div>
